        ...
        <ul class="breadcrumb">
			...
			Tên khoa:	<select name="cartoon">
				...
				<div class="themcauhoi">
					<form action="ThemLop.php" method="POST" enctype="multipart/form-data">
						<button typy="submit" name="btnthem">Thêm lớp</button>
					</form>
				</div>
					</div>
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Lớp</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  <th class="lop">Mã lớp</th>
								  <th class="lop">Tên lớp</th>
						  ...
						  <?php
							...
							{?>
							<tr>
								<td class="center"><?php echo $value['MaLop']; ?></td>
								<td class="center"><?php echo $value['TenLop']; ?></td>
								<td class="center">
